        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
                Expert Dock Lighting Installation
              </h2>
              <p className="text-lg text-slate-300">
                Ready to illuminate your Fair Haven waterfront? Call our lighting specialists for a custom design consultation and expert installation.
              </p>
            </div>
                ...
                <div className="space-y-6">
                  <a href="tel:+18449012684" className="flex items-start gap-4 hover:opacity-80 transition-opacity group">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-400">Expert marine consultations</div>
                    </div>
                  </a>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white text-sm">design@fairhavenmarinelight.com</div>
                      <div className="text-sm text-slate-400">For custom design inquiries</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                <label htmlFor="service" className="text-sm font-medium text-slate-700">Lighting Interest</label>
                <select id="service" className="w-full h-10 px-3 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option>New Dock Lighting</option>
                  <option>Piling Light Upgrade</option>
                  <option>Underwater LED Setup</option>
                  <option>Smart Control Install</option>
              ...
              <div className="space-y-2">
                ...
                <textarea id="message" className="w-full h-32 px-3 py-2 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Tell us about your dock..." />
              </div>
              <Button type="submit" className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white text-lg font-medium">
                Send Request
              </Button>
              <p className="text-xs text-slate-500 text-center mt-4">
                Or call us directly at (844) 901-2684
              </p>
            </form>
          </div>
        </div>

          ...
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
                24/7 Hillside Flood Response
              </h2>
              <p className="text-lg text-slate-300">
                Garage flooding in Tiburon? Don't let it damage your foundation. Call our emergency line now.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white">Tiburon, CA</div>
                      <div className="text-sm text-slate-400">94920</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white text-sm">emergency@tiburonrestoration.com</div>
              ...
              <div className="bg-slate-800/50 rounded-2xl p-8 backdrop-blur-sm border border-slate-700">
                ...
                <div className="grid grid-cols-1 gap-3 text-sm text-slate-300">
                  <div className="flex items-center gap-2"><span className="text-blue-500">•</span> Tiburon</div>
                  <div className="flex items-center gap-2"><span className="text-blue-500">•</span> Belvedere</div>
                  <div className="flex items-center gap-2"><span className="text-blue-500">•</span> Mill Valley</div>
                  <div className="flex items-center gap-2"><span className="text-blue-500">•</span> Corte Madera</div>
                  <div className="flex items-center gap-2"><span className="text-blue-500">•</span> Sausalito</div>
                  <div className="flex items-center gap-2"><span className="text-blue-500">•</span> Strawberry</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                ...
                <select id="service" className="w-full h-10 px-3 rounded-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option>Flooded Garage</option>
                  <option>Storm Runoff</option>
                  <option>Mudslide Cleanup</option>
                  <option>Drainage Failure</option>
                  <option>Other</option>
                </select>
              </div>
              <div className="space-y-2">

...
const Hero = ({
  title = (
    <>
      Smoke Odor Removal Attic Woodland Park
      <span className="block text-amber-400 mt-2">Woodland Park Attic Restore: Pure Air for Your Elevated Home.</span>
    </>
  ),
  subtitle = "Eliminate persistent smoke odors from your attic with our specialized restoration process. We deep clean insulation, wood structures, and use advanced fogging to restore air quality.",
  image = "/smoke-odor-attic-hero.png"
}: HeroProps) => {
  return (
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={image}
          alt="Smoke Odor Removal Attic Woodland Park"
        ...
        <div className="max-w-3xl">
          <div className="animate-fade-in">
            <span className="inline-block px-4 py-2 bg-amber-700/40 border border-amber-400/50 rounded-full text-amber-100 text-sm font-medium mb-6 backdrop-blur-sm">
              Woodland Park's Professional Attic Restoration Team
            </span>
          </div>

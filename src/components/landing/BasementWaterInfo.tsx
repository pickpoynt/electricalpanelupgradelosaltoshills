...
const BasementWaterInfo = () => {
    return (
        <section id="basement-water-removal" className="py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-gradient-to-r from-blue-900 to-slate-900 rounded-2xl shadow-2xl p-10 text-white mb-16">
                        <h3 className="text-3xl font-bold mb-8 text-center">
                            Our Comprehensive Basement Water Removal Process
                        </h3>
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="text-center">
                                <div className="bg-blue-700 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                                    1
                                </div>
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="text-xl font-bold mb-3">Water Extraction</h4>
                                <p className="text-blue-100 leading-relaxed">
                                    Powerful submersible pumps and truck-mounted extractors remove standing water quickly, minimizing absorption into floors, walls, and belongings.
                                </p>
                            </div>
                            <div className="text-center">
                                <div className="bg-blue-700 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                                ...
                                <h4 className="text-xl font-bold mb-3">Complete Drying</h4>
                                <p className="text-blue-100 leading-relaxed">
                                    Industrial dehumidifiers and air movers run continuously, with moisture monitoring until all materials reach safe levels for mountain climate.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-10 mb-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                                <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">Sump Pump Failures</h4>
                                    <p className="text-slate-700">
                                        Power outages during storms or mechanical failures leave basements vulnerable to flooding, especially during heavy precipitation or snowmelt events.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                                <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">Foundation Cracks</h4>
                                    <p className="text-slate-700">
                                        Freeze-thaw cycles create and expand foundation cracks, allowing groundwater seepage during wet seasons and creating persistent moisture problems.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                                <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">Appliance Malfunctions</h4>
                                    <p className="text-slate-700">
                                        Water heater failures, washing machine hose bursts, and HVAC condensate line clogs release water directly into basement spaces.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                                <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">Inadequate Drainage</h4>
                                    <p className="text-slate-700">
                                        Clogged gutters, poor grading, and overwhelmed French drains direct water toward foundations instead of away from the property.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-slate-800 to-blue-900 rounded-2xl shadow-2xl p-10 text-white">
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <div className="space-y-4 text-lg">
                                    ...
                                    <p className="leading-relaxed">
                                        <strong className="text-blue-300">Insurance Coordination:</strong> We work directly with your insurance company, providing detailed documentation, moisture readings, and photographic evidence to support your claim and expedite the restoration process.
                                    </p>
                                    <p className="leading-relaxed">
                                        <strong className="text-blue-300">Certified Technicians:</strong> Our water damage restoration specialists hold IICRC certifications and receive ongoing training in the latest extraction techniques, drying science, and mold prevention protocols.
                                    </p>
                                    <p className="leading-relaxed">
                                        <strong className="text-blue-300">Complete Restoration:</strong> Beyond water removal, we handle structural repairs, flooring replacement, drywall restoration, and final cleaning to return your basement to pre-flood condition.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default BasementWaterInfo;
